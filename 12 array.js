...
arr2.length = 5;
console.log(arr2[0],arr2[4],arr2[5],arr2[9],arr2[100]); //10 50 undefined undefined undefined
*/
...
console.log(arr);       //[ 10, 20, 40, 50, 60, 70, 80, 90 ]
arr.splice(9,0,100);
console.log(arr);       //[ 10, 20, 40, 50, 60, 70, 80, 90, 100 ]
arr.splice(1);
console.log(arr);   //[10]

let arr1 = [ 10, 20, 40, 50, 60, 70, 80, 90, 100 ];
// arr1.splice(-4,2);
// console.log(arr1);       //[ 10, 20,  40, 50, 60, 90, 100 ]
arr1.splice(-4,-2);
console.log(arr1);          //nothing will deleted
